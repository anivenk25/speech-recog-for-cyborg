...
def preprocess_audio(audio_file_path):
    """
    Preprocesses audio file by reducing noise.
    ...
    """
    audio_data, _ = librosa.load(audio_file_path, sr=None)  # Load audio file
    noise_sample = audio_data[:5000]  # Take a sample of the first 5 seconds for noise profile
    audio_data = reduce_noise(audio_data, noise_sample, verbose=False)
    return audio_data
...
# Recognize speech from preprocessed audio
